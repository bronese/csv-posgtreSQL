/*! UIkit 3.16.19 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */ (function (
  ve,
  we
) {
  ...
  function bt(t) {
    return Ge(t) || (D(t) && !isNaN(t - parseFloat(t)));
  }
  function $e(t) {
  ...
  const Ze = { ratio: Hi, contain: As, cover: Lo };
  ...
  function Ds(t, e = document) {
    return (D(t) && Os(t)) || Ve(e) ? e : e.ownerDocument;
  }
  const jo = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g,
  ...
  function Vi(t) {
    return Q(t) ? t.map(Ko).filter(Boolean) : D(t) ? Ce(t) : Ms(t) ? [t] : k(t);
  }
  function It(t) {
  ...
  function c(t, e, i, s) {
    ...
    for (const o of n)
      if (D(e)) {
        if (((e = ti(e)), Y(i))) return getComputedStyle(o).getPropertyValue(e);
        o.style.setProperty(
          e,
          bt(i) && !Zo[e] ? `${i}px` : i || Ge(i) ? i : "",
          s
        );
      } else if (Q(e)) {
        const r = {};
  ...
  function Ki(t, e) {
    return k(
      k(t).map((i) => (i.hasChildNodes() ? ni(Qt(i.childNodes), e) : L(i, e)))
    );
  }
  function Ee(t) {
    k(t)
  ...
  function _(t, e) {
    ...
    St(c(t, ["left", "top"]), (n, o) =>
      c(t, o, e[o] - i[o] + $(s === "absolute" && n === "auto" ? oi(t)[o] : n))
    );
  }
  function oi(t) {
  ...
  function Ls(t) {
    ...
    return (i, s) => {
      ...
      } else return c(i, t, !s && s !== 0 ? "" : +s + le(i, t) + "px");
    };
  }
  ...
  function ur() {
    return (
      ...
      (he ||
        ((he = w("<div>")),
        c(he, { height: "100vh", position: "fixed" }),
  ...
  const Lt = typeof window < "u",
    ...
    ce = Lt && window.PointerEvent,
    mt = ce ? "pointerdown" : Wt ? "touchstart" : "mousedown",
    ai = ce ? "pointermove" : Wt ? "touchmove" : "mousemove",
    Pt = ce ? "pointerup" : Wt ? "touchend" : "mouseup",
    Rt = ce ? "pointerenter" : Wt ? "" : "mouseenter",
    ue = ce ? "pointerleave" : Wt ? "" : "mouseleave",
    li = ce ? "pointercancel" : "touchcancel",
    J = {
      reads: [],
      writes: [],
      read(t) {
  ...
  ts.prototype = {
    ...
    init() {
      this.positions = [];
      let t;
      (this.unbind = x(document, "mousemove", (e) => (t = ae(e)))),
  ...
  function Sr(t, e) {
    for (const { name: i, handler: s, immediate: n = !0 } of t._watches)
      ((t._initial && n) || (vt(e, i) && !Xe(e[i], t[i]))) &&
        s.call(t, t[i], e[i]);
    t._initial = !1;
  }
  function Ir(t) {
  ...
  function Or() {
    as ||
      ...
      (as = new MutationObserver(() => {
        for (const t of Ae) di(t, "computed");
      })),
  ...
  function ls(t, e, i) {
    ...
    !n ||
      (h && !h.call(t)) ||
      t._events.push(
        x(n, s, l ? (D(l) ? l : l.call(t, t)) : null, D(o) ? t[o] : o.bind(t), {
          passive: a,
          capture: r,
          self: u,
        })
  ...
  (V.events =
    ...
    (V.update = function (t, e) {
      return Je(hs(t, it(e) ? { read: e } : e), "order");
    }),
  ...
  function Oe(t, e, i) {
    ...
    if (
      (it(e) && (e = e.options),
      e.extends && (t = Oe(t, e.extends, i)),
      e.mixins)
    )
      for (const o of e.mixins) t = Oe(t, o, i);
  ...
  function vn(t, e = {}) {
    (e.data = Vr(e, t.constructor.options)),
      (t.$options = Oe(t.constructor.options, e, t)),
      (t.$props = {}),
      (t._uid = jr++),
      qr(t),
      Ur(t),
  ...
  (ft.util = yr), (ft.options = {}), (ft.version = "3.16.19");
  const Yr = "uk-",
    qt = "__uikit__",
    pe = {};
  function wn(t, e) {
    var i;
    const s = Yr + Kt(t);
    if (!e) return yt(pe[s]) && (pe[s] = ft.extend(pe[s])), pe[s];
    (t = be(t)), (ft[t] = (o, r) => Be(t, o, r));
    ...
    return (
      ...
      ft._initialized &&
        !n.functional &&
        requestAnimationFrame(() => Be(t, `[${s}],[data-${s}]`)),
      (pe[s] = n)
    );
  }
  function Be(t, e, i, ...s) {
  ...
  function bn(t, e) {
    ...
    for (const i of ne(t).reverse()) $n(i, e);
    Ct(t, (i) => $n(i, e));
  }
  function $n(t, e) {
    const i = Ut(t);
  ...
  function Kr(t) {
    (t.prototype.$mount = function (e) {
      ...
      (t.prototype.$destroy = function (e = !1) {
        const i = this,
          { el: s } = i.$options;
        s && fs(i), de(i, "destroy"), Xr(s, i), e && lt(i.$el);
      }),
      (t.prototype.$create = Be),
        ...
        async toggleElement(t, e, i) {
          try {
            return (
              await Promise.all(
                k(t).map((s) => {
                  const n = Bi(e) ? e : !this.isToggled(s);
  ...
  async function sa(
    ...
    try {
      ...
      c(t, Yh), Ee(Oi.firstChild), e || r(t, !1);
    }
  }
  function na(t, e, i) {
    gt.cancel(t);
  ...
  var En = {
      ...
      observe: [Me({ args: { intersecting: !1 } }), pt()],
      update: {
        read({ visible: t }) {
          return Xs(this.$el)
            ? {
    ...
    events: [
      ...
      },
      {
        ...
        handler({ defaultPrevented: t, current: e }) {
          const { hash: i } = e;
          !t && i && re(e) && !B(i, this.$el) && this.hide(!1);
        },
      },
      {
        name: "beforescroll",
      ...
      },
      {
        ...
        handler(t) {
          ...
          s === I.DOWN &&
            ...
            (t.preventDefault(), (e = w(ke, n.$el)) == null || e.focus()),
            Bn(t, this.items, n);
        },
      },
      {
      ...
      },
      {
        read(t) {
          ...
          const n = T(this.$el),
            ...
            a = Math.max(...o) + r;
          this.masonry &&
            ((e = e.map((h) => Je(h, "offsetTop"))), (s = ya(i, e)));
  ...
  function Ca(t) {
    ...
    const i = b(t).height - le(t, "height", "content-box");
    return c(t, e), i;
  }
  var Ta = {
      props: {
      ...
      observe: pt({ target: ({ $el: t }) => [t, ...fe(t)] }),
      update: {
        read({ minHeight: t }) {
          if (!j(this.$el)) return !1;
          let e = "";
          const i = le(this.$el, "height", "content-box"),
      ...
      beforeConnect() {
        if (
          ((this.icon =
            ...
            ne(this.$el, ".uk-search-large").length
              ? "search-large"
              : ne(this.$el, ".uk-search-navbar").length
              ? "search-navbar"
              : this.$props.icon),
    ...
    events: [
      {
        ...
        handler(t) {
          const { current: e, defaultPrevented: i } = t,
            { hash: s } = e;
          !i && s && re(e) && !B(s, this.$el) && w(s, document.body)
            ? this.hide()
  ...
  function wl(t) {
    return x(document, "focusin", (e) => {
      se(nt) === t && !B(e.target, t.$el) && t.$el.focus();
    });
  }
  function bl(t) {
    return x(document, mt, ({ target: e }) => {
        ...
        },
        {
          ...
          handler() {
            this.mode === "reveal" &&
              ...
              (ni(this.panel, "<div>"), y(O(this.panel), this.clsMode));
      ...
      update: {
        read() {
          return j(this.$el) && this.width && this.height
            ? { width: Pe(O(this.$el)), height: this.height }
            : !1;
        },
        write(t) {
          et(
            this.$el,
            Ze.contain({ height: this.height, width: this.width }, t).height
          );
        },
        events: ["resize"],
      },
  ...
  var Dl = {
      ...
      watch: {
        elements(t) {
          this.hidden && c(Se(t, `:not(.${this.inViewClass})`), "opacity", 0);
        },
      },
      connected() {
    ...
    Bl = {
      ...
      computed: {
        links(t, e) {
          return z('a[href*="#"]', e).filter((i) => i.hash && re(i));
        },
        elements({ closest: t }) {
  ...
  function ws(t, e, i, s) {
    ...
    if (bt(t) || (D(t) && t.match(/^-?\d/))) return i + ht(t, "height", e, !0);
    {
      ...
      return _(n).bottom - (s && n && B(e, n) ? $(c(n, "paddingBottom")) : 0);
    }
  }
  function Un(t) {
  ...
  var Kn = {
      ...
      observe: [
        Ne({ targets: ({ connectChildren: t }) => t }),
      ...
      methods: {
        ...
        show(t) {
          const e = this.toggles.filter((r) => !C(r, bs)),
            i = this.index(),
            s = rt(!Ye(t) || m(e, t) ? t : 0, e, rt(this.toggles[i], e)),
  ...
  var jl = {
      ...
      computed: {
        target({ target: t }, e) {
          return (t = Ie(t || e.hash, e)), (t.length && t) || [e];
        },
      },
      connected() {
        m(this.mode, "media") ||
      ...
      events: [
        {
          ...
          handler(t) {
            (this._preventClick = null),
              !(!It(t) || this._showState || this.$el.disabled) &&
                (v(this.$el, "focus"),
                R(
                  document,
                  mt,
  ...
  function th(t, e) {
    return ["filter", "sort"].every((i) => Xe(t[i], e[i]));
  }
  function eh(t, e, i) {
    const s = sh(t);
  ...
  function wo(t, e, i, s) {
    ...
    if (je(e, "backgroundSize", "") === "cover") return $h(t, e, i, s);
    const r = {};
  ...
  function Re(t, e) {
    const [i, s, n] = xo(t, e);
    return Ge(i) ? i + Math.abs(i - s) * n * (i < s ? 1 : -1) : +s;
  }
  const yh = /^-?\d+(\S+)?/;
  function Ei(t, e) {
    var i;
  ...
  function Ih(t, e, i, { center: s, easing: n, list: o }) {
    const r = t ? qe(t, o, s) : qe(e, o, s) + b(e).width * i,
      a = e ? qe(e, o, s) : r + b(t).width * i * (X ? -1 : 1);
    let l;
    return {
      dir: i,
      show(h, u = 0, f) {
  ...
  function _i(t, e) {
    return (
      (t && (oi(t).left + (X ? b(t).width - b(e).width : 0)) * (X ? -1 : 1)) ||
      0
    );
  }
  function To(t, e) {
      ...
      methods: {
        init(t) {
          ...
          !n ||
            ...
            (this.placeholder = n),
            (this.origin = { target: e, index: oe(n), ...this.pos }),
        ...
        move(t) {
          ...
          this === t
            ? this.origin.index !== oe(this.placeholder) &&
  ...
  function Dh(t) {
    ...
    Ao = setInterval(() => {
      ...
      (e = Date.now()),
        fe(document.elementFromPoint(i, t.y))
          .reverse()
          .some((o) => {
  ...
  function Nh(t, e) {
    return t[xt(t, (i) => Ke(e, i.getBoundingClientRect()))];
  }
